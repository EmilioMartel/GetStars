package com.marquelo.getstars.menu_lobby_fragments.search.featured;
...
public class FeaturedFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        recyclerFeatured = root.findViewById(R.id.recyclerFeatured);
        recyclerFeatured.setLayoutManager(new GridLayoutManager(this.getContext(),1));
    ...
    private View cargarVista(LayoutInflater inflater, ArrayList<Famoso> listaFamoso) {
        root = inflater.inflate(R.layout.fragment_featured, null, false);
        AdapterSearchFeatured adapter = new AdapterSearchFeatured(listaFamoso);
        recyclerFeatured.setAdapter(adapter);
