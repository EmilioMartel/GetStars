...
public class LeerPrivatePolicy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Privace Policy");
        setContentView(R.layout.activity_leer_private_policy);
        ...
        String path = "terminosDeUso/PrivacyPolicy.pdf";
